    ...
    public static boolean connectBlueTooth(Context context) {
        if (bluetoothSocket == null) {
            if (getBTAdapter() == null) {
                Log.e(TAG, "connectBlueTooth: Bluetooth Adapter is null");
                return false;
            }
            if (!getBTAdapter().isEnabled()) {
                Log.e(TAG, "connectBlueTooth: Bluetooth Adapter disable");
                return false;
            }
            BluetoothDevice device;
            if ((device = getDevice(getBTAdapter())) == null) {
                Log.e(TAG, "connectBlueTooth: device is null");
                return false;
            }
            ...
            try {
                ...
                Log.e(TAG, "connectBlueTooth: exception " + e.getLocalizedMessage());
                return false;
            }
        }
        return true;
